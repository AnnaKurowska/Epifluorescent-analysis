## Macro used for images with 4 channels; DAPI, Cy3, Cy5 and GFP. The macro runs through all folders holding 4 separate channel images each from the main folder.
